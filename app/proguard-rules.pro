...
-keep enum com.journeyapps.barcodescanner.**{ *; }
...
-keep class com.coolerfall.widget.lunar.**{ *; }
-keep interface com.coolerfall.widget.lunar.**{ *; }
-keep enum com.coolerfall.widget.lunar.**{ *; }
